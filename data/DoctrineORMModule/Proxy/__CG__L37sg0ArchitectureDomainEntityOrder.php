...
namespace DoctrineORMModule\Proxy\__CG__\L37sg0\Architecture\Domain\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Order extends \L37sg0\Architecture\Domain\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'customer', 'orderNumber', 'description', 'total', 'id'];
        }
